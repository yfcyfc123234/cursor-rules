...
├── user-base-rule.mdc                    ✅ 自动导入
├── hardware-limitations.mdc              ✅ 自动导入
├── documentation-format.mdc              ✅ 自动导入
├── ui-design-reconstruction.mdc          ✅ 自动导入
├── auto-import-rules.mdc                 ✅ 自动导入
├── project-rules-auto-management.mdc     ✅ 自动导入
├── rules-conflict-management.mdc         ✅ 自动导入
├── github-rules-sync.mdc                 ✅ 自动导入（但避免循环拉取）
├── batch-file-operations.mdc             ✅ 自动导入
└── git-automation.mdc                    ✅ 自动导入
```
